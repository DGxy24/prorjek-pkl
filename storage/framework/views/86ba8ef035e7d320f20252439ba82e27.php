...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/border.css')); ?>" rel="stylesheet">
...
<body>
    ...
    <?php echo $__env->make('dashboard-admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="container-fluid">
        <div class="row">
            <?php echo $__env->make('dashboard-admin.layout.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH D:\Program\PKL\prorjek-pkl\resources\views/dashboard-admin/layout/main.blade.php ENDPATH**/ ?>