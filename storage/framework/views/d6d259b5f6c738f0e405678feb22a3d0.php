        ...
        <div class="sidebar-content flex-grow-1">
            <ul class="nav flex-column">
                <li class="nav-item dropdown">
                    <a class="nav-link text-center dropdown-toggle <?php echo e(Request::is('dashboard-admin/user*') ? 'active' : ''); ?>"
                ...
                <li class="nav-item dropdown mt-3 mb-3">
                    <a class="nav-link text-center dropdown-toggle <?php echo e(Request::is('dashboard-admin/tiket*') ? 'active' : ''); ?>"
        ...
        <div class="mt-auto">
            <ul class="nav flex-column">
                <li class="nav-item mb-3">
                    <a class="nav-link text-center <?php echo e(Request::is('dashboard/logout*') ? 'active' : ''); ?>"
                        style="background-color: #374750; border-radius:50px; color:white" href="<?php echo e(route('logout')); ?>">
...
<?php /**PATH D:\Program\PKL\prorjek-pkl\resources\views/dashboard-admin/layout/sidebar.blade.php ENDPATH**/ ?>